    ...
    <section class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle <?php echo ($activePage == 'tasks_admin_unassigned.php' || $activePage == 'tasks_admin.php' || $activePage == 'tasks_completed_admin.php' || $activePage == 'admin_create_task_calendar.php') ? 'active' : ''; ?>" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    Tareas
                </a>
