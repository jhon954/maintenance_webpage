...
<head>
    ...
    <link href="../css/styles_edit_task.css" rel="stylesheet">
    <!-- scripts -->
        ...
        <section class="row">
            <section class="col-sm-6">
                ...
                <section class="form-group">
                    ...
                    <select class="form-control" id="id_collaborator" name="id_collaborator">
                        ...
                        ?>
                        <option value="<?php echo $collaborator['id'] ?>"> <?php echo $collaborator["name"] ." ". $collaborator["surname"] ?></option>
                        <?php endforeach; else: ?>
            ...
            <section class="col-sm-6">
                <section class="form-group">
                    ...
                    <textarea class="form-control" id="job_description" name="job_description" rows="2"><?php echo $task_data['job_description']; ?></textarea>
                </section>
                <section class="form-group">
