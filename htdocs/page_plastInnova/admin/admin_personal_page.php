            ...
            <section class="col-md-9">
                <section class="profile-info">
                    <section class="profile-info-item row">
                        <span class="profile-info-label col-sm-2 col-md-2">Título:</span>
                        <span class="profile-info-value col-sm-10 col-md-10"><?php echo $_SESSION['job_title']?></span>
                    </section>
                    <section class="profile-info-item row"> 
                        <span class="profile-info-label col-sm-2 col-md-2">Nombre:</span>
                        <span class="profile-info-value col-sm-10 col-md-10"><?php echo $_SESSION['name']." ". $_SESSION['surname']?></span>
                    </section>
                    <section class="profile-info-item row">
                        <span class="profile-info-label col-sm-2 col-md-2">Nickname:</span>
                        <span class="profile-info-value col-sm-10 col-md-10"><?php echo $_SESSION['nickname']?></span>
                    </section>
                </section>
            </section>
    </section>
